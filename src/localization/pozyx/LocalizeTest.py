...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x972d, 1, Coordinates(4350, 160, 960)),
               DeviceCoordinates(0x9733, 1, Coordinates(560, 3420, 760)),
               DeviceCoordinates(0x971a, 1, Coordinates(1600,160, 960))]
